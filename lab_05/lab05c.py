...
def main():
    ...
    for line in file:
        ...
        total_bmi += bmi
        count += 1
        print(f"{name:<12s}{height:<12.2f}{weight:<12.2f}{bmi:<12.2f}", file=outfile)
    print("\n{:<12s}{:<12.2f}{:<12.2f}{:<12.2f}".format("Average", total_height/count, total_weight/count, total_bmi/count), file=outfile)
